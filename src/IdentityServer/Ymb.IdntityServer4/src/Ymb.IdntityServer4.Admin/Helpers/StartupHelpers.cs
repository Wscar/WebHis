...
using Ymb.IdntityServer4.Admin.ExceptionHandling;
using Ymb.IdntityServer4.Admin.Configuration;
using Ymb.IdntityServer4.Admin.Configuration.ApplicationParts;
using Ymb.IdntityServer4.Admin.Configuration.Constants;
using Ymb.IdntityServer4.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories.Interfaces;
using Ymb.IdntityServer4.Admin.Helpers.Localization;
using System.Linq;
using Ymb.IdntityServer4.Admin.EntityFramework.MySql.Extensions;
using Ymb.IdntityServer4.Admin.EntityFramework.Shared.Configuration;
//using Ymb.IdntityServer4.Admin.EntityFramework.SqlServer.Extensions;
//using Ymb.IdntityServer4.Admin.EntityFramework.PostgreSQL.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using Ymb.IdntityServer4.Shared.Authentication;
using Ymb.IdntityServer4.Shared.Configuration.Identity;

namespace Ymb.IdntityServer4.Admin.Helpers
{
