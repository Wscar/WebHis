...
using SendGrid;
using Ymb.IdntityServer4.Shared.Configuration.Email;
using Ymb.IdntityServer4.Shared.Email;
using Ymb.IdntityServer4.STS.Identity.Configuration;
using Ymb.IdntityServer4.STS.Identity.Configuration.ApplicationParts;
using Ymb.IdntityServer4.STS.Identity.Configuration.Constants;
using Ymb.IdntityServer4.STS.Identity.Configuration.Interfaces;
using Ymb.IdntityServer4.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace Ymb.IdntityServer4.STS.Identity.Helpers
{
