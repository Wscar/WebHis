...
using Ymb.IdntityServer4.STS.Identity.ViewModels.Manage;

namespace Ymb.IdntityServer4.STS.Identity.Controllers
{    
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Ymb.IdntityServer4.STS.Identity"),
